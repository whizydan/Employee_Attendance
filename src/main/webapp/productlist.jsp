...
<%
    ...
    while(result.next()){
        ...
        newProduct.setId(result.getInt("id"));
        newProduct.setCategory(result.getString("category"));
        newProduct.setName(result.getString("category"));
        newProduct.setCode(result.getString("code"));
        newProduct.setBrand(result.getString("brand"));
        newProduct.setPrice(result.getShort("price"));
        newProduct.setUnit(result.getString("unit"));
        newProduct.setQuantity(result.getInt("quantity"));
        newProduct.setAdded_by(result.getString("added_by"));
        newProduct.setPhoto(result.getString("photo"));
...
<script type="text/javascript">
        function handleClick() {
            // Your JavaScript code to run when the list item is clicked
            window.print();
            // You can perform other actions or functions here.
        }
    </script>
</head>
<body>
...
<div class="wordset">
<ul>
<li id="print" onclick="handleClick()">
...
<div  class="card mb-0" hidden id="filter_inputs">
...
<td><%=item.getBrand()%></td>
<td><%=item.getPrice()%>.00</td>
<td><%=item.getUnit()%></td>
<td><%=item.getQuantity()%>.00</td>
<td><%=item.getAdded_by()%></td>
<td>
<a class="me-3" href="product-details.jsp?id=<%=item.getId()%>">
<img src="assets/img/icons/eye.svg" alt="img">
</a>
<a class="me-3" href="addproduct.jsp?op=edit&id=<%=item.getId()%>">
<img src="assets/img/icons/edit.svg" alt="img">
</a>
<a href="deleteProduct.jsp?id=<%=item.getId()%>">
<img src="assets/img/icons/delete.svg" alt="img">
        ...
        %>
        <li class="notification-message">There are not products yet, come back later</li>
        <%
        }
%>
</tbody>
