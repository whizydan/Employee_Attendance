...
<%
    ...
    String email="";
    ResultSet res = db.executeQuery("select * from vendors where id='"+id+"'");
    while(res.next()){
    ...
    if (request.getMethod().equalsIgnoreCase("post")){
        ...
        response.setContentType("text/html");
            PrintWriter oust = response.getWriter();
            oust.println("<script type='text/javascript'>");
            oust.println("alert('Email has ben sent');");
            oust.println("</script>");
    }
...
<a href="subcategorylist.jsp" class="btn btn-cancel">Cancel</a>
</div>
</div>
</div>
</div>
