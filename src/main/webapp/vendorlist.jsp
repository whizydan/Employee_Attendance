...
<%
    ...
    List<vendors> vendor = new ArrayList<>();
    ResultSet results = db.executeQuery("select * from vendors");
    while(results.next()){
        vendors user = new vendors();
...
<div class="page-btn">
<a href="createvendor.jsp" class="btn btn-added"><img src="assets/img/icons/plus.svg" class="me-2" alt="img">Add New Vendor</a>
</div>
</div>
...
<td><%=item.getPhone()%></td>
<td><%=item.getEmail()%></td>
<td><span class="badges bg-lightred"><%=item.getCountry()%></span></td>
<td>
<a class="me-3" href="emailvendor.jsp?id=<%=item.getId()%>">
<img src="assets/img/icons/email.svg" alt="img">
</a>
<a class="me-3" href="createvendor.jsp?id=<%=item.getId()%>">
<img src="assets/img/icons/edit.svg" alt="img">
</a>
<a class="me-3" href="deletevendor.jsp?id=<%=item.getId()%>">
