...
<%
    ...
    ResultSet result = db.executeQuery("select * from sub_category");
    while(result.next()){
        Categories category = new Categories();
        category.setId(result.getInt("id"));
        category.setName(result.getString("name"));
        category.setAdded_by(result.getString("added_by"));
...
<li><a class="active" href="subcategorylist.jsp">Sub Category List</a></li>
...
<a href="subaddcategory.jsp" class="btn btn-added"><img src="assets/img/icons/plus.svg" class="me-2" alt="img"> Add Sub Category</a>
</div>
</div>
...
<% 
        if (subCategories != null && !subCategories.isEmpty()) {
            for (Categories item : subCategories) {
        %>
        <tr>
<td>
<label class="checkboxs">
...
<td>
<a class="me-3" href="editsubcategory.jsp?id=<%=item.getId()%>">
<img src="assets/img/icons/edit.svg" alt="img">
</a>
<a class="me-3" href="deleteSub.jsp?id=<%=item.getId()%>">
