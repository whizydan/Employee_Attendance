...
<li><a href="attendancelist.jsp">Attendance List</a></li>
<li><a class="active" href="attendance.jsp">Add Attendance</a></li>
</ul>
</li>
<li class="submenu">
...
<form method="post" action="VerifyServlet" enctype="multipart/form-data">
...
<label>Staff</label>
<select name="staff" class="select" required>
<% 
...
<select name="clock" class="select" required>
...
<div class="col-lg-3 col-sm-6 col-12">
<video autoplay style="height: 250px;width: 250px"></video>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<canvas id='takePhotoCanvas' style="height: 250px;width: 250px"></canvas>
</div>
<div class="col-lg-12">
<div class="form-group">
<input hidden name="email" type="text" value="<%=(String)new SessionManager().getSessionAttribute(request,"email")%>"/>
  <input required hidden  id="image" type="text" name="image"/>
</div>
</div>
<div class="col-lg-12">
...
<div class="col-lg-12">
    <input id='takePhotoButton' type="submit" value="Submit" name="submit" class="btn btn-submit me-2">
<a href="attendancelist.jsp" class="btn btn-cancel">Cancel</a>
</div>
</div>
</div>
</div>
