...
<div class="page-btn">
<a href="createexpense.jsp" class="btn btn-added"><img src="assets/img/icons/plus.svg" class="me-2" alt="img">Add New Staff</a>
</div>
</div>
...
<td><%=item.getId()%></td>
<td><%=item.getEmail()%></td>
<td><span class="badges bg-secondary"><%=item.getCreated_on()%></span></td>
