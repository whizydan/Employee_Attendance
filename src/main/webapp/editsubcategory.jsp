...
<%
    ...
    ResultSet result = db.executeQuery("select * from sub_category where id='"+id+"'");
    while(result.next()){
    ...
    if (request.getMethod().equalsIgnoreCase("post")){
        ...
        String query = "update sub_category  set name='"+name+"', description='"+description+"' where id='"+id+"'";
