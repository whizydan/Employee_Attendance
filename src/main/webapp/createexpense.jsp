...
<%
    ...
    String firstName="",firstDate="",firstEmail="", position ="";int firstStatus=0;
    int role = 1;
    if(id != null){
        ResultSet set = db.executeQuery("select * from users where id = '"+id+"'");
        while(set.next()){
        firstName = set.getString("name");
        firstDate = set.getString("created_on");
        firstEmail = set.getString("email");
        firstStatus = set.getInt("status");
...
<ul>
<li><a class="active" href="expenselist.jsp">Staff list</a></li>
...
<input value="<%=firstDate%>" name="date" required type="text" placeholder="Choose Date" class="datetimepicker">
<div class="addonset">
...
<div class="input-groupicon">
<input value="<%=firstName%>" required name="name" type="text">
</div>
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
<label>Email</label>
<input value="<%=firstEmail%>" name="email" required type="text">
...
<input value="123" required name="password" type="text">
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
<label>Position</label>
<input <%if(id != null){%> value="<%=position%>" <%}%> required name="pos" type="text">
</div>
</div>
<div class="col-lg-12">
<div class="form-group">
...
<a href="expenselist.jsp" class="btn btn-cancel">Cancel</a>
</div>
</div>
</div>
</div>
